...
import com.dkay229.msql.domain.ExecuteQueryResponse;
...
public class MultiStatement implements Statement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ExecuteQueryResponse executeQueryResponse = multiServerClient.executeQuery(sql);
        return new MultiResultsSet(multiServerClient, executeQueryResponse.getRowMetadata().getColumnMetadata());
    }
