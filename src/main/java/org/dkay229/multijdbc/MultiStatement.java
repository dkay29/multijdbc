...
public class MultiStatement implements Statement {
    private final MultiServerClient multiServerClient;

    public MultiStatement(MultiServerClient multiServerClient) {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ArrayList<Dbserver.ColumnMetadataOrBuilder> l = new ArrayList<>();
        for (Dbserver.ColumnMetadataOrBuilder c:l) {
            l.add(new Dbserver.ColumnMetadataOrBuilder(c) {
                @Override
                ...
                @Override
                public Dbserver.ColumnMetadata.TypeEnum getType() {
                    return null;
                }
        ...
        return new MultiResultsSet(multiServerClient,multiServerClient.executeQuery(sql).getResultsMetaData().getColumnsList());
    }
